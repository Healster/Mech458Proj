...
void main(int argc,char*argv[])
{
	...
	DDRA = 0xFF; /* Pins 0-5 are set to output and 6-7 set to input*/
	...
	else if (obj_ADC_meas>800 && obj_ADC_meas<960) { //add white to queue
...
void PWM () {
	...
	OCR0A = 0x66; //66 scale clock to 40% duty cycle
